    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light custom-navbar" >
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="{{ asset('img/logo desa.png') }}" alt="Logo Desa" width="30" height="30" class="d-inline-block align-text-top">
            NAGORI NAGORI TONGAH
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-flex">
              <button class="btn btn-primary me-2" type="button" style="background-color:#3A655D;">Login</button>
              <button class="btn btn-secondary" type="button" style="background-color:#2B2B2B;">Register</button>
            </div>
          </div>
        </div>
    </nav>
