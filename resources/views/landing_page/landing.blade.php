...
<section id="fitur">
	<div class="row d-flex flex-wrap">
		<div class="card-group">
				...
				<div class="box" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
					<div class="card" onclick="window.location.href='login';">
						<div class="card-body text-center">
							<img src="img/4.png" class="card-img-top-1" alt="...">
			...
			<div class="col-sm-2 mx-auto">
				<div class="box" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
					<div class="card" onclick="window.location.href='forum_diskusi/guest';">
						<div class="card-body text-center">
							<a href="{{ route('posts.guest') }}"><img src="img/1.png" class="card-img-top-1" alt="..."></a>
			...
			<div class="col-sm-2 mx-auto">
				<div class="box" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
					<div class="card" onclick="window.location.href='umkm_landing';">
						<div class="card-body text-center">
							<a href=""><img src="img/3.png" class="card-img-top-1" alt="..."></a>
			...
			<div class="col-sm-2 mx-auto">
				<div class="box" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
					<div class="card" onclick="window.location.href='chart/guest';">
						<div class="card-body text-center">
							<a href="{{ route('transparasi.guest') }}"><img src="img/4.png" class="card-img-top-1" alt="..."></a>
