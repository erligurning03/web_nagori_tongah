...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/magnific-popup.css') }}">

    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/aos.css') }}">

    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/ionicons.min.css') }}">
    
    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{ asset ('landing_assets/assets/css/style.css') }}">
  </head>
  <body>
...
>>>>>>> 5d9c9017662c2864ebce9cf08ce9de3504169ae3
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-project owl-carousel">
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing_assets/assets/images/project-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<a href="{{ asset('landing_assets/assets/images/project-1.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset ('landing_assets/assets/images/project-2.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<a href="{{ asset ('landing_assets/assets/images/project-2.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ ('landing_assets/assets/images/project-3.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<a href="{{ ('landing_assets/assets/images/project-3.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ ('landing_assets/assets/images/project-4.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<a href="{{ ('landing_assets/assets/images/project-4.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing_assets/assets/images/project-5.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<a href="{{ asset('landing_assets/assets/images/project-5.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
  ...
  <script src="{{ asset('landing_assets/assets/js/jquery.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery-migrate-3.0.1.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/popper.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/bootstrap.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery.easing.1.3.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery.waypoints.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery.stellar.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/owl.carousel.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery.magnific-popup.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/aos.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/jquery.animateNumber.min.js') }}"></script>
  <script src="{{ asset('landing_assets/assets/js/scrollax.min.js') }}"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="{{ asset('landing_assets/assets/js/google-map.js') }}"></script>
