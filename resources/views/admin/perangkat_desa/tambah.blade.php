...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="blank.html">Tambah Perangkat Desa</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/admin_assets/assets/img/undraw_profile_1.svg"
                                            alt="...">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Perangkat Desa</h1>
                    ...
                    <form action="{{ route('submit-form') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="numberOfInputs" id="numberOfInputs" min="1" placeholder="Enter the number of inputs">
                        </div>
                    ...
                    {{-- <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="masukkan nama" aria-label="default input example">
                            </div>
                        </div>
                    </div> --}}
    ...
    <script>
        // JavaScript code to dynamically generate form inputs based on user input
    
        document.getElementById('numberOfInputs').addEventListener('input', function() {
            ...
            for (var i = 1; i <= numberOfInputs; i++) {
                var inputHTML = '<div class="form-group">' +
                                '<label for="input' + i + '">Data Input ' + i + ':</label>' +
                                '<input class="form-control" type="text" name="input' + i + '" placeholder="Enter data ' + i + '">' +
                                '</div>';
