...
use App\Http\Controllers\FormUmkmController;
...
Route::get('/formumkm', [FormUmkmController::class, 'index'])->name('umkm.formumkm');
Route::post('/umkm_store', [FormUmkmController::class, 'store'])->name('formumkm.store');
